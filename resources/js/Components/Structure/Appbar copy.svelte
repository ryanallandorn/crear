    ...
    <div class="container-fluid d-flex flex-wrap justify-content-between ps-0 h-100">
        ...
        <div class="d-flex align-items-center">
                    ...
                    <svelte:fragment slot="content">
                        ...
                        {#if teams.allTeams.length > 1}
                            ...
                            {#each teams.allTeams as team}
                                <DropdownLink href="javascript:void(0);" on:click={() => switchTeam(team)}>
                                    {team.name}
                                </DropdownLink>
                            {/each}
                        {/if}
            ...
            <div class="flex-shrink-0 dropdown me-3">
                <a href="javascript:void(0);" class="d-block link-body-emphasis text-decoration-none dropdown-toggle" data-bs-toggle="dropdown">
