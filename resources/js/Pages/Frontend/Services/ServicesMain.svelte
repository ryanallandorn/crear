    ...
    <AppFrontend>
        ...
        <Hero>
            ...
            <div slot="mainHeading">
                <h4 class="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Ex Nihilo</h4>
            </div>
            <div slot="paragraph">
                <div class="flex items-center justify-center space-x-4">
                    <div class="flex items-center space-x-2">
                        <span class="text-sm text-gray-500 italic">sustantivo</span>
                        <span class="text-sm text-gray-500">/ɛks ˈniː.hɪ.li.oʊ/</span> <!-- Phonetics -->
